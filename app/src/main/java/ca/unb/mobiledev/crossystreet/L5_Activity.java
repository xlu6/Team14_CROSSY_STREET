...
public class L5_Activity extends AppCompatActivity {

    private L5_GameView gameView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayerL = MediaPlayer.create(L5_Activity.this, R.raw.traffic2);
        mediaPlayerL.setLooping(true);
        mediaPlayerL.start();

        mediaPlayerCrash = MediaPlayer.create(L5_Activity.this, R.raw.impact_car_crash);
        ...
        //create L1 gameview
        gameView = new L5_GameView(this, point.x, point.y);
        ...
        //initiate pause button on Level 5
