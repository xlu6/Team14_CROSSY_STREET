...
public class L2_Activity extends AppCompatActivity {

    private L2_GameView gameView;
   ...
   protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayerL = MediaPlayer.create(L2_Activity.this, R.raw.traffic2);
        mediaPlayerL.setLooping(true);
        mediaPlayerL.start();

        mediaPlayerCrash = MediaPlayer.create(L2_Activity.this, R.raw.impact_car_crash);
        ...
        //create L1 gameview
        gameView = new L2_GameView(this, point.x, point.y);
        ...
        //initiate pause button on Level 1
