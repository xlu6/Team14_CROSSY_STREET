...
public class L1_Activity extends AppCompatActivity {
   ...
   protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayerL = MediaPlayer.create(L1_Activity.this, R.raw.traffic2);
        mediaPlayerL.setLooping(true);
        mediaPlayerL.start();

        mediaPlayerCrash = MediaPlayer.create(L1_Activity.this, R.raw.impact_car_crash);
        ...
        //create L1 gameview
        gameView = new L1_GameView(this, point.x, point.y);
