...
public class L3_Activity extends AppCompatActivity {

    private L3_GameView gameView;
   ...
   protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayerL = MediaPlayer.create(L3_Activity.this, R.raw.traffic2);
        mediaPlayerL.setLooping(true);
        mediaPlayerL.start();

        mediaPlayerCrash = MediaPlayer.create(L3_Activity.this, R.raw.impact_car_crash);
        ...
        //create L3 gameview
        gameView = new L3_GameView(this, point.x, point.y);
