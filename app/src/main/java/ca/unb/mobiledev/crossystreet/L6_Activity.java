...
public class L6_Activity extends AppCompatActivity {

    private L6_GameView gameView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayerL = MediaPlayer.create(L6_Activity.this, R.raw.traffic1);
        mediaPlayerL.setLooping(true);
        mediaPlayerL.start();

        mediaPlayerCrash = MediaPlayer.create(L6_Activity.this, R.raw.impact_car_crash);
        ...
        //create L1 gameview
        gameView = new L6_GameView(this, point.x, point.y);
        ...
        //initiate pause button on Level 6
